...
print(f"✓ Loaded {len(dataset)} claims from mock dataset\n")
...
for i, entry in enumerate(dataset, 1):
    ...
    print(f"✓ Retrieved {num_evidence} evidence items ({high_cred} high credibility)\n")
    ...
    print(f"✓ Verdict: {predicted} (confidence: {confidence:.2f})\n")
    ...
    print(f"✓ Run recorded (accuracy: {accuracy:.2f})")
...
with open(obs_file, 'w') as f:
    ...
    f.write("- ✅ Based on peer-reviewed research\n\n")
...
print(f"\n✓ Detailed observations saved to: {obs_file}")
...
print("\n✅ System successfully demonstrated all 6 agents working together!")
